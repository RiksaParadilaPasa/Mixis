package com.example.mixis.adapter.mixi;
...
public class AdapterPartnerHome extends RecyclerView.Adapter<AdapterPartnerHome.ViewHolder> {

    private List<EntityPartnerHome> partnerHomeListList;
    private Mixi mContext;

    public AdapterPartnerHome(Mixi mContext, List<EntityPartnerHome> partnerHomeListList){
...
//          ini untuk inisialisasi entity
        EntityPartnerHome partnerHome = partnerHomeListList.get(position);
